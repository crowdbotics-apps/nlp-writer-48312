"""
Django settings for nlp_writer_48312 project.
...
ROOT_URLCONF = 'nlp_writer_48312.urls'
...
WSGI_APPLICATION = 'nlp_writer_48312.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nlp_writer_48312 API",
    "DESCRIPTION": "API documentation for nlp_writer_48312 App",
    "VERSION": "v1",
}
